...
public class CustomerController {
	...
	public String processChangePassword(@ModelAttribute("changePassword") ChangePassword changePassword,
			Model theModel) {
	 ...
	 * public String viewCustomerCart(@RequestParam("bookId") int bookId, Model
	 * theModel) {
	 * String message = null;
	 * Customer customer = currentSession.getUser().getCustomer();
	 * message = theShoppingCartService.removeItem(customer,
	 * theBookService.getBookById(bookId));
	 * Set<ShoppingCart> shoppingItems =
	 * theShoppingCartService.getAllItems(customer);
