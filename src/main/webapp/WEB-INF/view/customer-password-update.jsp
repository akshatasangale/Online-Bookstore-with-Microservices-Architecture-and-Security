                                            ...
                                            <form:form method="POST" action="/customers/password/change" modelAttribute="changePassword">
                                                ...
                                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td style="color:green;">Enter Old Password: </td>
                                                            <td>
                                                                <form:password path="oldPassword" /> </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="color:green;">Enter New Password: </td>
                                                            <td>
                                                                <form:password path="newPassword" /> </td>
                                                        </tr>
                                                        <tr>
