                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <h1 class="h3 mb-4 text-gray-800">
                                            <b> Welcome to the Online Book Store <br> Browse our collection of books and find your next read !!!</b>
                                        </h1>
                                        <!-- Buy Book Button -->
                                        <a href="${pageContext.request.contextPath}/books" class="btn btn-primary btn-lg mt-4" style="padding: 15px 30px; font-size: 1.25rem;">
                Buy Book
            </a>
                                    </div>
                                    <!-- Right Content -->
                                    <div class="col-md-4">
                                        <img src="${pageContext.request.contextPath}/img/book.jpg" alt="Book Image" class="img-fluid rounded shadow" style="width: 100%; max-width: 500px; height: auto;">
                                        <br><br><br><br><br><br>
                                    </div>
                                </div>
                            </div>
                            ...
                            <footer class="sticky-footer bg-white">
                                <div class="container my-auto">
                                    <div class="copyright text-center my-auto">
                                        <span>github.onlinebookstore 2024</span>
                                    </div>
                                </div>
                            </footer>
                            <!-- End of Footer -->
