                                            ...
                                            <form:form method="POST" modelAttribute="customerData" action="/customers/profile/update/process">
                                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td style="color:green;">First Name: </td>
                                                            <td>
                                                                <form:input path="firstName" /> </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="color:green;">Last Name: </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td style="color:green;">Mobile Number: </td>
                                                            <td>
                                                                <form:input path="mobile" /> </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td style="color:green;">Password(Encrypted)</td>
                                                            <td>***************************************************************</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="color:green;">Enter Password to update</td>
                                                            <td>
                                                                <form:password path="password" placeholder="Confirm Password.." />
                                                            </td>
                                                        </tr>
                                                        <tr>
                        ...
                        <footer class="sticky-footer bg-white">
                            <div class="container my-auto">
                                <div class="copyright text-center my-auto">
                                    <span>github.onlinebookstore 2024
